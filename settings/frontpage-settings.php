...
class frontpage_settings_tab extends settings_page_tab {
    ...
    protected function create_page_settings() {
        ...
        $this->add_setting_configtextarea('frontpage_buttons_configtextarea_when_user_logged', true, 'frontpage_button_courses,theme_suap|my/courses.php||| (/n) frontpage_button_learningpaths,theme_suap|theme/suap/learningpaths.php|||');
